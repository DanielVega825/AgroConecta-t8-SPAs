        ...
        <div class="row text-center g-4">
            ...
            <div class="col-md-3 mb-4">
                <div class="card tarjeta-equipo p-4">
                    <h5 class="nombre-equipo">Cesar España Salguero</h5>
                    <p class="rol-equipo">
                        25 años <br>
                        Data Science / Desarrollador Full Stack
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card tarjeta-equipo p-4">
                    <h5 class="nombre-equipo">Ivan Dario Chavez</h5>
                    <p class="rol-equipo">
                        29 años <br>
                        Desarrollador
                    </p>
            ...
            <div class="col-md-3 mb-4">
                <div class="card tarjeta-equipo p-4">
                    <h5 class="nombre-equipo">José Daniel Vega</h5>
                    <p class="rol-equipo">
                        25 años <br>
            ...
            <div class="col-md-3 mb-4">
                <div class="card tarjeta-equipo p-4">
                    <h5 class="nombre-equipo">Juan David Castro Rubiano</h5>
                    <p class="rol-equipo">
                        40 años <br>
                        Desarrollador Jr Full Stack Java
                    </p>
                </div>
            </div>
